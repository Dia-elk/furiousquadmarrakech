...
<div class="container">
    ...
    <div class="message">
        ...
        To see your reservation <a href="furiousquadmarrakech.com/reservation/{{$reservation->id}}">Click Here</a>
    </div>
    ...
    <div class="message">
        We look forward to welcoming you on {{$reservation->reservation_date}}. If you have any questions or need to make changes to your reservation, please contact us at <a href="mailto:furiousmarrakech@gmail.com">furiousquadmarrakech@gmail.com</a> or call us at +212 6 36 47 37 27.
        <br><br>
